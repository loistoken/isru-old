		...
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					...
					$btn_output = ' <button class="button uk-border-rounded uk-button uk-button-secondary uk-margin-top uk-width-1-1 font" onclick="this.form.searchword.focus();"><i class="fas fa-search"></i></button>';
				endif;
