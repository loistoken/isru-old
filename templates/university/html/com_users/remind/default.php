...
<div class="remind <?php echo $this->pageclass_sfx; ?>">
    <div class="uk-flex-center" uk-grid>
        <div class="uk-width-1-1 uk-width-1-3@l">
            <div>
                <h3 class="font uk-text-center uk-text-left@l">Forgot Username</h3>
                <form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="form-validate form-horizontal well">
                    ...
                    <div><p class="font uk-text-small uk-text-center uk-text-left@l"><?php echo JText::_($fieldset->label); ?></p></div>
