...
{	
	...
	public function rsfp_bk_onAfterShowFormScriptsTabs()
	{
		...
		<table class="admintable table">
			...
			<tr>
				<td colspan="2"><?php echo RSFormProHelper::showEditor('pdf[useremail_php]', $this->row->useremail_php, array('classes' => 'rs_100', 'syntax' => 'php')); ?></td>
			</tr>
			<tr class="info">
			...
			<tr>
				<td colspan="2"><?php echo RSFormProHelper::showEditor('pdf[adminemail_php]', $this->row->adminemail_php, array('classes' => 'rs_100', 'syntax' => 'php')); ?></td>
			</tr>
		</table>
		</div>
		<?php
