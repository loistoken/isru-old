...
if(trim($author->images) != ""){
	if($img_align == 0){
    	$image = '<img class="author-image thumbnail pull-left" src="'.JURI::root().$author->images.'" />';
	}
	else{
		$image = '<img class="author-image thumbnail pull-right" src="'.JURI::root().$author->images.'" />';
	}
}
