...
<form action="index.php?option=com_guru&controller=guruAuthor&pid=<?php echo $pid; ?>" id="adminForm" name="adminForm" method="post">
    ...
    <a href="<?php echo JURI::root().'index.php?option=com_guru&view=guruPrograms&task=view&cid='.intval($pid).'&preview=true'; ?>" target="_blank" class="uk-button uk-button-success"><?php echo JText::_("GURU_PREVIEW_COURSE"); ?></a>
