    ...
    <form class="uk-form uk-form-horizontal" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" onsubmit="return validateTerms()">
		...
		?>
                ...
                <ul class="uk-switcher uk-margin" id="tab-content">
					<li id="general-tab-content" class="uk-active uk-margin-top content-tab">
                    ...
                    <li id="photo-tab-content" class="uk-margin-top content-tab">
                        <div class="uk-form-row">
                            <label class="uk-form-label" for="name">
                    ...
                    <li id="bio-tab-content" class="uk-margin-top content-tab">
                        <div class="uk-form-row">
                            <div class="">
                                <?php
                                    $doc = JFactory::getDocument();
