...
<div>
    <form action="index.php" name="adminForm" method="post">
        ...
        ?>
                <tr class="guru_row">	
                        <td class="guru_product_name g_cell_1"><a href="<?php echo JRoute::_("index.php?option=com_guru&view=guruPrograms&task=view&cid=".$id."-".$alias."&Itemid=".$itemid_course); ?>"><?php echo $course->course_name; ?></a>
                        <?php								
